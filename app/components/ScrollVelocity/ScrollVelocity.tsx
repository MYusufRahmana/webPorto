// app/components/ScrollVelocity/ScrollVelocity.tsx
"use client";
...
function VelocityText({
  ...
  // Use type assertion or make the hook more flexible
  const copyWidth = useElementWidth<HTMLSpanElement>(copyRef);
